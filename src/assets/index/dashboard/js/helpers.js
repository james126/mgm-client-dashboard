			...
			var d = {
				...
				scrollPageTo: function(e) {
					...
					var i = n.scrollTop
						...
						, r = +new Date;
					!function a() {
						var s, l, u, c = +new Date - r, d = (s = c,
							l = i,
							u = o,
							(s /= t / 2) < 1 ? u / 2 * s * s + l : -u / 2 * ((s -= 1) * (s - 2) - 1) + l);
						n.scrollTop = d,
					...
					setTimeout((function() {
							...
							document.querySelector(".content-wrapper > .menu-horizontal > div") && (f = !0,
								...
								a && (e._removeClass("container-fluid", a),
									e._addClass("container-xxl", a)))) : (c.some((function(e) {
										return [i, l].includes(e)
									}
					...
					null != e && e.forEach((function(e) {
							e.addEventListener("click", (function(t) {
									...
									"text" === o.getAttribute("type") ? (o.setAttribute("type", "password"),
										i.classList.replace("mdi-eye-outline", "mdi-eye-off-outline")) : "password" === o.getAttribute("type") && (o.setAttribute("type", "text"),
										i.classList.replace("mdi-eye-off-outline", "mdi-eye-outline"))
								}
							))
						}
					))
					...
					setTimeout((function() {
							document.querySelectorAll(".nav-tabs").forEach((function(e) {
									...
									if (!t) {
										...
										n.setAttribute("class", "tab-slider"),
											t = e.appendChild(n)
									}
									var i = e.closest(".nav-align-left") || e.closest(".nav-align-right")
										...
										i ? (t.style.top = r.y - o.y + "px",
											t.style[e.closest(".nav-align-right") ? "inset-inline-start" : "inset-inline-end"] = 0,
											t.style.height = r.height + "px") : (t.style.left = a + "px",
